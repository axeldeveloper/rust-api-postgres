...
│   ├── ...
│   └── Dockerfile
├── compose.yaml   # run  backend and FontEnd
├── back.yaml      # run to backend
└── README.md
```
...
$ docker compose -f 'back.yaml' up -d
...
WARNING: Image for service frontend was built because it did not already exist. 
